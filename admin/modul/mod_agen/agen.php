...
switch($_GET[act]){
  ...
  default:
    echo "<h2>Data Agen</h2>
          <input type=button class='tombol' value='Tambah Data' onclick=\"window.location.href='?module=agen&act=tambah';\">
          <table>
          <tr><th>No</th><th>Nama Perusahaan</th><th>Alamat</th><th>Telepon</th><th>Aktif</th><th>Aksi</th></tr>";
    ...
    while ($r=mysql_fetch_array($tampil)){
		echo "<tr>
			...
			<td>$r[hp]</a></td>
			<td>$r[aktif]</td>
			<td><a href=?module=agen&act=edit&id=$r[id_agen]><b>Edit</b></a> | 
				  <a href=$aksi?module=agen&act=hapus&id=$r[id_agen]><b>Hapus</b></a>
			</td>
			</tr>";
		$no++;
    }
